...
namespace SSHFrom
{
    public class SFTPHelper
    {
        ...
        public List<string> GetFileList(string remotePath,bool isDir)
        {
            try
            {
                ...
                {
                    if (isDir == qqq.getAttrs().isDir())
                    {
                        //objList.Add(qqq.getLongname().ToString());
                        objList.Add(qqq.getFilename().ToString());
                    }
                }
                return objList;
            }
